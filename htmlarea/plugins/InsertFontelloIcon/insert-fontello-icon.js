 ...
 */
HTMLArea.InsertFontelloIcon = Ext.extend(HTMLArea.Plugin, {
        ...
        Ext.iterate(this.icons, function (id, map) {
            tabItems.push({
                ...
                tpl: new Ext.XTemplate(
                    '<link rel="stylesheet" type="text/css" href="../typo3conf/ext/iconfont/Resources/Public/Lib/fontello/css/fontello.css" media="all"> ' +
                        '<div>' +
                        '   <tpl for=".">' +
