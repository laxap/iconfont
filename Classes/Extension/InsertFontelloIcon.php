 ...
 *
 */
class InsertFontelloIcon extends RteHtmlAreaApi {

	// The key of the extension that is extending htmlArea RTE
	protected $extensionKey = 'iconfont';

	// The name of the plugin registered by the extension
	protected $pluginName = 'InsertFontelloIcon';

	protected $pluginButtons = 'fonticon';

	protected $convertToolbarForHtmlAreaArray = array(
		'fonticon' => 'InsertFontelloIcon'
	);
	...
	protected $relativePathToSkin = 'extensions/InsertFontelloIcon/skin/htmlarea.css';
