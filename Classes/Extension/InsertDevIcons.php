 ...
 *
 */
class InsertDevIcons extends \TYPO3\CMS\Rtehtmlarea\RteHtmlAreaApi {

	// The key of the extension that is extending htmlArea RTE
	protected $extensionKey = 'iconfont';

	// The name of the plugin registered by the extension
	protected $pluginName = 'InsertDevIcons';
	...
	protected $relativePathToSkin = 'extensions/InsertDevIcons/skin/htmlarea.css';
